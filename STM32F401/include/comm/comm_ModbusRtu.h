...
{
    Byte ChannelID;     // Идентификатор UART-выхода
...
{
    Bool ListenMode;      // Флаг режима "Listen Only"
...
typedef struct _TMbPort
{
    ...
    TSerialInterface Serial; // Последовательный интерфейс
} TMbPort, *TMbHandle;

// Прототипы Modbus коммуникации
