...
typedef struct _TPpData
    ...
    Uns X_VibrData; // данные виброскорости с датчика по оси X
    Uns Y_VibrData; // данные виброскорости с датчика по оси Y
    Uns Z_VibrData; // данные виброскорости с датчика по оси Z
    ...
    Byte RxFrame[SPI_FRAME_BUF_SIZE]; // Буфер чтения
    Byte TxFrame[SPI_FRAME_BUF_SIZE]; // Буфер записи
