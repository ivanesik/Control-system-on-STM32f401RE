...
// Так как значение виброскорости передается по стандарту IEEE-754 (с плавающей запятой),
...
{
    Uns X_VibrData; // Бинарные данные виброскорости по оси X
    Uns Y_VibrData; // Бинарные данные виброскорости по оси Y
    Uns Z_VibrData; // Бинарные данные виброскорости по оси Z

    Float X_Vibr; // Виброскорость по оси X
