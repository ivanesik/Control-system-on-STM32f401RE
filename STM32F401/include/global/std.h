 ...
 */
    ...
    typedef signed char SmInt;  /* 8-bit signed integer */
    typedef signed short MdInt; /* 16-bit signed integer */
    typedef signed long LgInt;  /* 32-bit signed integer */

    typedef unsigned char SmUns;  /* 8-bit unsigned integer */
    typedef unsigned short MdUns; /* 16-bit unsigned integer */
    typedef unsigned long LgUns;  /* 32-bit unsigned integer */

    typedef unsigned char SmBits;  /* 8-bit bit string */
    typedef unsigned short MdBits; /* 16-bit bit string */
    typedef unsigned long LgBits;  /* 32-bit bit string */
